...
if(isset($_POST['submitFilter'])){
  ...
  $language = $_POST['lang'];
  header('location:filteredPage.php?loc='.$location.'&gen='.$gender.'&sal='.$salary.'&whrs='.$workingHrs.'&rel='.$religion.'&lan='.$language);
}
// $sortby = $_POST['sortby'];

// echo $sortby;
$stmt = "SELECT * FROM registered";
          ...
          <form action="#" method="POST" id="filter">
            ...
            <div id="selectSalary">
              ...
              <select name="salary" class="custom-select custom-select-sm mb-3">
                ...
                <option value="9">7000-9000</option>
                <option value="11">9000-11000</option>
                <option value="14">11000-14000</option>
                <option value="16">14000-16000</option>
                <option value="18">16000-18000</option>
                <option value="20">18000-20000</option>
              </select>
            </div>
            <br>
            ...
            <div class="card-header">
              <div class="row ml-2">
                ...
                <div class="col col-lg-3 pt-4 float-rght">
                  <button class="btn btn-sm btn-danger"><?php  echo '+91-'.$row['mobile']; ?></button>
                </div>
              </div>
            </div>
            <div class="card-body">
